...
#model = load_model(r'model/model_10_epochs_6Classes(lr=0.0001,bs=25)_(3200_800).h5')# loading the model.
...
def predict_sentimets():
	for i in glob.glob('uploads/*.*'):
		...
		return res
                ...
                #print(probs)
#Topic : Recommender System for Shopping: A Design for Smart Malls 		                    (Feb 2018)                                                                        